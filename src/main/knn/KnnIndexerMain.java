...
public class KnnIndexerMain {
  ...
  public static void main(String[] args) throws Exception {
    ...
    new KnnIndexer(inputs.docVectorsPath, inputs.indexPath,
                   KnnGraphTester.getCodec(inputs.maxConn, inputs.beamWidth, exec, numMergeWorker, quantize, quantizeBits, quantizeCompress, knn.KnnGraphTester.IndexType.HNSW, 0),
